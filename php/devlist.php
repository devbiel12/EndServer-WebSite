...
<h1 id="devText">Listagem De Desenvolvedores Cadastrados</h1>
<center>
<?php
    include "conexao.php";
    $query = mysqli_query($sql,"select * from caddesenvolvedor")
        ...
        while($linha = mysqli_fetch_array($query)){
            ...
            echo "
                <tr> 
                    ...
                    <td> $idade</td>
                    <td> $sexo</td>
                    <td><a href=\"editardev.php?codigo=$codigo\" id =\"editar\">[Editar]</td>
                    <td><a href=\"excluirdev.php?codigo=$codigo\" id =\"excluir\"> [Excluir]</td>
