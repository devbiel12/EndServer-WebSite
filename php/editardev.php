...
<?php
        ...
        $id = $_GET["codigo"];
        $query = mysqli_query($sql,"select * from caddesenvolvedor where codigo = $id");
...
<div id="formplayer">
   <form type="text" name="meu_form" method="post" action="../php/alteracaodev.php">
    ...
    <input type="submit" id="Cadastrar" value="Alterar" action="devlist.php">
</form>
</div>
</body>
</html>